...
//     EXPECT_EQ(err.what(),
//               std::string("cannot create s21::vector larger than
//               max_size()"));
//   }
// }
...
//     std::initializer_list<int> il_initial = {4, 5, 6};
//     std::initializer_list<int> il_add = {9, 8, 7};

//     s21::stack<int> s21_stack{il_initial};
//     std::stack<int> std_stack;
//     for (auto it = il_initial.end(); it != il_initial.begin();) {
//         std_stack.push(*(--it));
//     }

//     s21_stack.insert_many_front(7, 8, 9);
//     for (auto it = il_add.end(); it != il_add.begin();) {
//         std_stack.push(*(--it));
//     }
...
//     std::initializer_list<int> il_initial = {10};
//     std::initializer_list<int> il_add = {20};
...
//     s21_stack.insert_many_front(20);
//     for (auto it = il_add.end(); it != il_add.begin();) {
//         std_stack.push(*(--it));
//     }
...
//     std::initializer_list<int> il_initial = {1, 2, 3};
//     std::initializer_list<int> il_add = {9, 8, 7, 6, 5, 4};
...
//     s21_stack.insert_many_front(4, 5, 6, 7, 8, 9);
//     for (auto it = il_add.end(); it != il_add.begin();) {
//         std_stack.push(*(--it));
//     }
